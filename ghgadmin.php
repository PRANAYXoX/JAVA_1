...
<style>
    body{
        ...
        font-size: 5px;
        color:green;
        background-image: url(ghg12.jpg);
        background-size: 160%;
    }
    h6{
        font-size: 27px;
...
if(isset($admin))
{
   ...
   <h1><?php echo"<center><h1> ADMIN-PANEL:<span style='color:red'>HOME<span> </h1><br><h6>ADMIN-NAME:<span  style='color:orangered;text-shadow:1px 1px 1px black;'> ".strtoupper($admin)."</span></h6></center>";?></h1> 
  <form id="head">
      <center><a href="ghgl6.html"> <input type="button" value="&#9851;HOME" class="bt"></a>
        ...
        <a href="ghgserchex.php"><abbr title="FILTER COMPANIES SECTORWISE"> <input type="button" value="&#128269;" class="bt2"></abbr></a>
        <a href="ghgl5.php"> <input type="button" value="&#9852;EXIT" class="bt2"></a>
...
<div class="container">
  ...
  <table class="table12" border='1' cellspacing="0">
    <thead>
      ...
      <?php
//include("dbconn.php");
 $query_select="SELECT * FROM ghgreg";  
