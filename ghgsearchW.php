...
if(isset($admin))
{
   ...
   <h1><?php echo"<center><h1> SECTOR:<span style='color:red'>WASTE<span> </h1><br><h6>ADMIN-NAME:<span  style='color:orangered;text-shadow:1px 1px 1px black;'> ".$admin."</span></h6></center>";?></h1> 
  <form id="head">
      <center><a href="ghgl6.html"> <input type="button" value="&#9851;HOME" class="bt"></a>
          ...
          <a href="ghgsearchW.html"> <input type="button" value="&#9852;WASTE" class="bt"></a>
   ...
   <?php
    ...
    $result=mysqli_query($conn,"SELECT * FROM ghgreg where sector='waste' ");
...
<div class="container">
  ...
  <table class="table12" border='1' cellspacing="0">
    <thead>
      ...
      <?php
//include("dbconn.php");
 $query_select="SELECT * FROM ghgreg where sector='waste' ";  
...
{ 
 ...
 ?>
     ...
     echo "<td><button class='update2'>SCRUTINIZED</button></td>    ";
      ...
      <?php } ?>
     <tr> <td colspan="11"> <?php   echo "TOTAL ROWS: ".$row1; ?></td></tr>
