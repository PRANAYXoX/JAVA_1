...
if(isset($admin))
{
   ...
   <h1><?php echo"<center><h1> SECTOR:<span style='color:red'>ENERGY<span> </h1><br><h6>ADMIN-NAME:<span  style='color:orangered;text-shadow:1px 1px 1px black;'> ".$admin."</span></h6></center>";?></h1> 
  <form id="head">
   ...
   <?php
    ...
    $result=mysqli_query($conn,"SELECT * FROM ghgreg  where sector='energy' ");
...
<div class="container">
  ...
  <table class="table12" border='1' cellspacing="0">
    <thead>
      ...
      <?php
//include("dbconn.php");
 $query_select="SELECT * FROM ghgreg where sector='energy' ";  
